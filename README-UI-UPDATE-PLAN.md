...
- [ ] Phase 2C: source pricing mapped/imported safely, Interior pricing and admin product controls verified, dashboard navigation/spacing updated
- [ ] Phase 2D: reference-style product layout/options implemented in our theme and saved 21st.dev components reviewed/documented
