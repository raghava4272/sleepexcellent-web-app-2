...
const series = [
  ["Essential", "Best value", "Balanced orthopedic support"],
  ["Classic", "Bestseller", "Orthopedic foam for side and back sleepers"],
  ["Infinity", "Advanced", "Lumbar-reinforced support for long-term comfort"],
  ["Ultra", "Premium", "Full-body contouring with advanced air flow"],
] as const;
const dimensions = {
